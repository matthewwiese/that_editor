    ...
    switch(ev.type)
    {
        ...
        case SDL_KEYDOWN:
        {
            ...
            switch(ev.key.keysym.scancode)
            {
                ...
                ALPHA(SDL_SCANCODE_4,'4','$', CTRL('4'), std::string_view("\44",   1), std::string_view("\0\173",2))
                ...
                ALPHA(SDL_SCANCODE_SLASH, '/','?',    CTRL('/'), std::string_view("\0\75", 1), std::string_view("\0\75",2))
                //
                ALPHA(SDL_SCANCODE_SEMICOLON, ';', ':', CTRL(';'), std::string_view("\0\47", 2), std::string_view("\0\47",2))
                ALPHA(SDL_SCANCODE_APOSTROPHE,'\'', '\"', CTRL('\''), std::string_view("\0\48", 2), std::string_view("\0\48",2))
                ALPHA(SDL_SCANCODE_BACKSLASH, '\\',   '|',    CTRL('\\'), std::string_view("\0\49", 2), std::string_view("\0\49",2))
                //
                ALPHA(SDL_SCANCODE_LEFTBRACKET, '[', '{', CTRL('['), std::string_view("\0\32", 2), std::string_view("\0\32",2))
                ALPHA(SDL_SCANCODE_RIGHTBRACKET,']',    '}',    CTRL(']'), std::string_view("\0\33", 2), std::string_view("\0\33",2))
                //
                ALPHA(SDL_SCANCODE_MINUS,  '-', '_',   CTRL('-'), std::string_view("\134",  1), std::string_view("\0\202",2))
